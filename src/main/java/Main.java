...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            if (message == MessageСonstants.REGISTRATION_FAIL) {
                ...
                console.printMessage("Вы успешно вошли в систему");
                while (true) {
                    nextActionOne();
                }
    ...
    private static void nextActionOne() {
        console.printMessage("Выберете действие:" +"\n" + "(1) просмотреть свои услуги;" + "\n" +
                                "(2) добавить услугу;" + "(3) удалить услугу;");
        ...
        if (nextAction == 1) {
            ...
            console.printMessage("Выберите одну из доступных услуг:");
    ...
    private static void getAllSubsByAdmin () {
